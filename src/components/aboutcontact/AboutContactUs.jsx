...
const AboutContactUs = () => {
    return (
        <div className="max-w-6xl mx-auto p-4 md:p-8 bg-white font-sans text-gray-800">
            <h1 className="text-3xl md:text-4xl font-bold text-red-600 text-center mb-10 uppercase tracking-wide">
                Contact us
            </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                ...
                <div className="space-y-6 flex flex-col">
                    <div className="flex items-start gap-4 bg-red-50 p-2 border-l-4 border-red-600 rounded-r-md">
                    ...
                    <div className="bg-red-50 p-2 border-l-4 border-red-600 rounded-r-md">
                ...
                <div className="bg-orange-50 border border-red-200 rounded-lg p-6 md:p-8 shadow-sm">
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:vishwajitsinha56@gmail.com" className="hover:text-red-600 font-bold transition-colors">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <a href="https://www.colvincricketcoachingacademy.com" target="_blank" rel="noreferrer" className="hover:text-red-600 font-bold transition-colors">
            ...
            <div className="mt-6 pt-8 border-t border-gray-100">
                <div className="flex items-start gap-4 mb-6">
                    <MapPin className="text-red-600 mt-1 shrink-0" size={24} />
                    <div>
                ...
                {/* Map Placeholder */}
                <div className="w-full h-80 rounded-xl overflow-hidden shadow-inner border border-gray-200 grayscale-[20%] hover:grayscale-0 transition-all duration-500">
                    <iframe
